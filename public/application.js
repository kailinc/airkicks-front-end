...
/***/ (function(module, exports, __webpack_require__) {
	...
	var shoe = __webpack_require__(32);
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://airkicks.herokuapp.com'
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var userUi = __webpack_require__(10);
	...
	var onSignUp = function onSignUp(e) {
	  ...
	  // console.log(data)
	  userApi.add(data).then(userUi.onSignUpSuccess).catch(userUi.onSignUpError);
	};
	...
	var onUserShoes = function onUserShoes() {
	  $('#successNotify').css('display', 'none');
	  $('#errorNotify').css('display', 'none');
	  var userId = store.user.id;
	  userApi.userShoes(userId).then(userUi.onUserShoesSuccess).catch(userUi.onUserShoesError);
	};

	var onUserCollections = function onUserCollections() {
	  $('#successNotify').css('display', 'none');
	  $('#errorNotify').css('display', 'none');
	  var userId = store.user.id;
	  userApi.userCollections(userId).then(userUi.onUserCollectionsSuccess).catch(userUi.onUserCollectionsError);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var userShoes = function userShoes(data) {
	  return $.ajax({
	...
	var userCollections = function userCollections(data) {
	  return $.ajax({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(9);
	var showUserShoesTemplate = __webpack_require__(11);
	var showUserCollectionsTemplate = __webpack_require__(31);
	var shoe = __webpack_require__(32);
	var collection = __webpack_require__(38);
	...
	var onSignUpError = function onSignUpError() {
	...
	var onUserShoesSuccess = function onUserShoesSuccess(data) {
	  $('#content').empty();
	  ...
	  if (data.user.shoes.length === 0) {
	    ...
	    var showUserShoesHTML = showUserShoesTemplate({ shoes: data.user.shoes });
	...
	var onUserShoesError = function onUserShoesError(error) {
	  // console.log(error)
	};

	var onUserCollectionsSuccess = function onUserCollectionsSuccess(data) {
	  $('#content').empty();
	  if (data.user.collections.length === 0) {
	    ...
	    var showUserCollectionsHTML = showUserCollectionsTemplate({ collections: data.user.collections });
	...
	var onUserCollectionsError = function onUserCollectionsError(error) {}
	// console.log(error)
	...
	;module.exports = {
	  ...
	  onUserShoesSuccess: onUserShoesSuccess,
	  onUserShoesError: onUserShoesError,
	  onUserCollectionsSuccess: onUserCollectionsSuccess,
	  onUserCollectionsError: onUserCollectionsError
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "  <div class=\"col col-md-3 grid\" data-shoe-id=\""
	    ...
	    + "\" data-shoe-brand=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.brand : stack1), depth0))
	    + "\" data-shoe-cap=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.caption : stack1), depth0))
	    + "\">\n    <img src=\"https://raw.githubusercontent.com/kailinc/airkicks-front-end/master/assets/img/run.png\">\n    <h3> "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + " x "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.brand : stack1), depth0))
	    + "</h3>\n    <p> "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.caption : stack1), depth0))
	    + "</p>\n    <button type=\"button\" class=\"btn btn-primary viewShoeBtn\">View Shoe</button>\n    <button type=\"button\" class=\"btn btn-primary editShoeBtn\">Edit Shoe</button>\n    <button type=\"button\" class=\"btn btn-danger deleteShoeBtn\">Delete Shoe</button>\n  </div>\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.shoes : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "  <div class=\"col col-md-3 grid\" data-collection-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" data-collection-name=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + "\" data-collection-description=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.description : stack1), depth0))
	    + "\" >\n    <img src=\"https://raw.githubusercontent.com/kailinc/airkicks-front-end/master/assets/img/collection.png\">\n    <h3> "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + "</h3>\n    <p> "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.description : stack1), depth0))
	    + "</p>\n    <button type=\"button\" class=\"btn btn-primary viewCollectionBtn\">View Collection</button>\n    <button type=\"button\" class=\"btn btn-primary editCollectionBtn\">Edit Collection</button>\n    <button type=\"button\" class=\"btn btn-danger deleteCollectionBtn\">Delete Collection</button>\n  </div>\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.collections : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
	},"useData":true,"useBlockParams":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var shoeApi = __webpack_require__(33);
	var shoeUi = __webpack_require__(34);
	var getFormFields = __webpack_require__(37);
	var user = __webpack_require__(7);

	var addShoe = function addShoe(e) {
	  e.preventDefault();
	  if ($('#addShoeBrand').val() === '') {
	    ...
	    var data = getFormFields(e.target);
	    // console.log(data)
	    shoeApi.add(data).then(shoeUi.onAddSuccess).catch(shoeUi.onAddError);
	  }
	};

	var viewShoe = function viewShoe() {
	  var shoeId = $(this).parent().attr('data-shoe-id');
	  shoeApi.show(shoeId).then(shoeUi.onShowSuccess).catch(shoeUi.onShowError);
	};

	var deleteShoe = function deleteShoe() {
	  var shoeId = $(this).parent().attr('data-shoe-id');
	  shoeApi.destroy(shoeId).then(shoeUi.onDestroySuccess).catch(shoeUi.onDestroyError);
	};

	var editShoe = function editShoe(event) {
	  ...
	  if ($('#editShoeBrand').val() === '') {
	    ...
	    var shoeId = $('#editShoeId').text();
	    var data = getFormFields(event.target);
	    shoeApi.update(data, shoeId).then(shoeUi.onUpdateSuccess).catch(shoeUi.onUpdateError);
	  }
	};

	var openEditModal = function openEditModal() {
	  var shoeId = $(this).parent().attr('data-shoe-id');
	  var shoeName = $(this).parent().attr('data-shoe-name');
	  var shoeBrand = $(this).parent().attr('data-shoe-brand');
	  var shoeCap = $(this).parent().attr('data-shoe-cap');
	...
	var allShoes = function allShoes() {
	  $('#successNotify').css('display', 'none');
	  $('#errorNotify').css('display', 'none');
	  shoeApi.index().then(shoeUi.onIndexSuccess).catch(shoeUi.onIndexError);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var shoeStore = __webpack_require__(9);
	var user = __webpack_require__(7);
	var showShoeTemplate = __webpack_require__(35);
	var showShoesTemplate = __webpack_require__(36);
	...
	var onDestroySuccess = function onDestroySuccess(data) {
	  $('#content').empty();
	  $('#successNotify').css('display', 'block').text('Your shoe has been deleted.');
	  $('#errorNotify').css('display', 'none');
	};

	var onDestroyError = function onDestroyError(error) {
	...
	var onShowSuccess = function onShowSuccess(data) {
	  $('#content').empty();
	  var showShoeHTML = showShoeTemplate(data);
	  $('#content').append(showShoeHTML);
	};

	var onShowError = function onShowError(error) {
	  // console.log(error)
	};
	...
	var onIndexSuccess = function onIndexSuccess(data) {
	  ...
	  $('#content').empty();
	  var showShoesHTML = showShoesTemplate({ shoes: data.shoes });
	  $('#content').append(showShoesHTML);
	};

	var onIndexError = function onIndexError(error) {
	  // console.log(error)
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n  <div class=\"col col-md-3 grid\" data-shoe-id="
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.shoe : depth0)) != null ? stack1.id : stack1), depth0))
	    + ">\n    <img src=\"https://raw.githubusercontent.com/kailinc/airkicks-front-end/master/assets/img/run.png\">\n    <h3> "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.shoe : depth0)) != null ? stack1.name : stack1), depth0))
	    + " x "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.shoe : depth0)) != null ? stack1.brand : stack1), depth0))
	    + "</h3>\n    <p> "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.shoe : depth0)) != null ? stack1.caption : stack1), depth0))
	    + "</p>\n  </div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "  <div class=\"col col-md-3 grid\" data-shoe-id=\""
	    ...
	    + "\">\n    <img src=\"https://raw.githubusercontent.com/kailinc/airkicks-front-end/master/assets/img/shoes.png\">\n    <h3> "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + " x "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.brand : stack1), depth0))
	    + "</h3>\n    <p> "
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var collectionApi = __webpack_require__(39);
	var collectionUi = __webpack_require__(41);
	var getFormFields = __webpack_require__(37);

	var addCollection = function addCollection(e) {
	  e.preventDefault();
	  var data = getFormFields(e.target);
	  // console.log(data)
	  collectionApi.add(data).then(collectionUi.onAddSuccess).catch(collectionUi.onAddError);
	};

	var deleteCol = function deleteCol() {
	  var collectionId = $(this).parent().attr('data-collection-id');
	  collectionApi.destroy(collectionId).then(collectionUi.onDeleteSuccess).catch(collectionUi.onDeleteError);
	};

	var showCol = function showCol() {
	  var collectionId = $(this).parent().attr('data-collection-id');
	  collectionApi.show(collectionId).then(collectionUi.onShowSuccess).catch(collectionUi.onShowError);
	};

	var openEditColModal = function openEditColModal() {
	  var collectionId = $(this).parent().attr('data-collection-id');
	  var colName = $(this).parent().attr('data-collection-name');
	  var colDes = $(this).parent().attr('data-collection-description');
	...
	var editCol = function editCol(event) {
	  event.preventDefault();
	  var collectionId = $('#editColId').text();
	  var data = getFormFields(event.target);
	  collectionApi.update(data, collectionId).then(collectionUi.onUpdateSuccess).catch(collectionUi.onUpdateError);
	};

	var allCol = function allCol() {
	  $('#successNotify').css('display', 'none');
	  $('#errorNotify').css('display', 'none');
	  collectionApi.index().then(collectionUi.onIndexSuccess).catch(collectionUi.onIndexError);
	};
	...
	module.exports = {
	  ...
	  deleteCol: deleteCol,
	  showCol: showCol,
	  openEditColModal: openEditColModal,
	  editCol: editCol
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(9);
	var shoeStore = __webpack_require__(40);
	var config = __webpack_require__(6);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var collectionStore = __webpack_require__(9);
	var showCollectionTemplate = __webpack_require__(42);
	var showColsTemplate = __webpack_require__(43);
	...
	var onShowSuccess = function onShowSuccess(data) {
	  $('#content').empty();
	  var showCollectionHTML = showCollectionTemplate(data);
	...
	var onIndexSuccess = function onIndexSuccess(data) {
	  $('#content').empty();
	  var showColsHTML = showColsTemplate({ collections: data.collections });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n  <div class=\"col col-md-3 grid\" data-shoe-id="
	    ...
	    + "</h3>\n    <p> "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.collection : depth0)) != null ? stack1.description : stack1), depth0))
	    + "</p>\n  </div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "  <div class=\"col col-md-3 grid\" data-col-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.colllection : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" data-col-name=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + "\" data-col-desc=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.description : stack1), depth0))
	    + "\">\n    <img src=\"https://raw.githubusercontent.com/kailinc/airkicks-front-end/master/assets/img/closet.png\">\n    <h3> "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + " </h3>\n    <p> "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.description : stack1), depth0))
	    + "</p>\n  </div>\n\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "3874158083ba344b82016dfe814afd67.jpg";

/***/ }),
/* 54 */
/***/ (function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "8f3591f0979b2926663b186dc2c75f7b.jpg";
